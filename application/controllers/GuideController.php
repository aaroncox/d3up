				...
				if($sections = $this->getRequest()->getParam('sections')) {
					...
					foreach($sections as $idx => $section) {
						...
						if($section['content'] != "null") {
							$cleaned = strip_tags($section['content'], '<p><a><img><div><li><h1><h2><h3><h4><h5><h6><h7><ul><ol><br/><br><pre><span><strong><em><bold><blockquote>');
							$sec['content'] = $cleaned;
						}
				...
				if($skills = $this->getRequest()->getParam('skills')) {
					...
					foreach($skills as $idx => $skill) {
						...
						if($skill['content'] != "null") {
							$cleaned = strip_tags($skill['content'], '<p><a><img><div><li><h1><h2><h3><h4><h5><h6><h7><ul><ol><br/><br><pre><span><strong><em><bold><blockquote>');
